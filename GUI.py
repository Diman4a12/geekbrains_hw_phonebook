...
def create_entry():
    ...
    ttk.Label(frame, text="Введите номер телефона 1 в формате: 8-ХХХ-ХХХ-ХХ-ХХ").pack(anchor=NW)
    phone_1 = ttk.Entry(frame)
    phone_1.pack(anchor=NW)
    ttk.Label(frame, text="Введите номер телефона 2 в формате: 8-ХХХ-ХХХ-ХХ-ХХ").pack(anchor=NW)
    phone_2 = ttk.Entry(frame)
    phone_2.pack(anchor=NW)
    ttk.Label(frame, text="Дату рождения в формате: ДД.ММ.ГГГГ").pack(anchor=NW)
